        ...
        <article>
            <div class="spnoibat">
                ...
                <div class="khungsanphams">
                    ...
                    ?>
                        <div class="sanphams">
                            <a href="?action=spchitiet&masanpham=<?php echo $spnoibat['masanpham'] ?>">
                                <div class="sanpham">
                                    <div><img src="./public/img/<?php echo $spnoibat['img'] ?>" alt=""></div>
                                    <div class="tensp"><?php echo $spnoibat['tensanpham'] ?></div>
                                    <div class="giasp"><?php echo $spnoibat['dongia'] ?></div>
                                </div>
                            </a>
                        </div>
                    <?php
